...
namespace WasaaMP {
    ...
    public class Launcher : MonoBehaviourPunCallbacks {
        ...
        private void Update()
        {
            playButton.interactable = !PhotonNetwork.NickName.Equals(string.Empty) && color != -1;
        }
        ...
        public void setColor(int c)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                buttons[i].interactable = i == c;
            }
            PlayerPrefs.SetFloat("red", colors[c].r);
            Debug.Log(colors[c].r);
            PlayerPrefs.SetFloat("green", colors[c].g);
            PlayerPrefs.SetFloat("blue", colors[c].b);
        }
